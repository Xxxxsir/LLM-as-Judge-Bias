judge_prompt = (
    ...
    "- 1–3 (Very Poor): Fails to adequately answer the question or severely violates instructions.\n\n"
    "- 0 (Corrupted): The response is empty, nonsensical, corrupted, or contains only gibberish or unrelated content. "
    "# Evaluation Steps\n"
